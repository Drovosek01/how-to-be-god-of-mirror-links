...
В общем, по описанным выше причинам (и возможным другим) файл по ссылке/ссылкам может быть недоступен для скачивания. Даже если автор публикации загрузил материал на несколько хостингов файлов, не факт, что они будут доступны для скачивания пол года или дольше. Зависит от того найдут ли и пожалуйются на эти ссылки службы защиты правообладателей и как быстро хостинги файлов подчинятся их требования, либо от популярности скачивания размещенного материала на хостингах файлов, либо от того, будет ли жив этот хостинг файлов через пол года (да, хостинги файлов тоже могут закрываться из-за нерентабельности).
